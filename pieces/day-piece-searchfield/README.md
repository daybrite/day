...
A search input for Day apps, realized as the platform's *distinct* search control where one
exists — `NSSearchField`, `UISearchTextField`, `GtkSearchEntry` — rather than a themed text
field.
