...
// ---------------------------------------------------------------------------
// XAML: this crate's OWN shim (src/lib-xaml-shim.cpp) — an Ellipse (circle) or Border+Image boxed
...
fn make(_backend: &mut Xaml, p: &RemoteImageProps, _id: NodeId) -> WinHandle {
...
fn update(_backend: &mut Xaml, h: &WinHandle, patch: &RemoteImagePatch) {
