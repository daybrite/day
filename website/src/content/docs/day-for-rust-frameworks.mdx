...
Rust UI frameworks differ in how they render controls and manage state. Day uses platform widgets
and signal bindings. The comparisons below relate its APIs to other Rust frameworks, with code
examples and notes on where each approach fits. [Why Day](/docs/benefits) covers the general tradeoffs.
