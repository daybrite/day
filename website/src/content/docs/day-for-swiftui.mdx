...
Day uses declarative composition, modifier chains, and a layout protocol similar to SwiftUI’s.
Its main differences are Rust, signal-based updates, and support for non-Apple platforms.
This guide compares the APIs and build tools. Existing SwiftUI views can also be
[embedded on Apple targets](#bringing-swiftui-views-with-you).
