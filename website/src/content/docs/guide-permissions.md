...
Platforms have different consent requirements for capabilities such as camera access, location,
and notifications. Day separates permission setup into a build-time declaration in `Day.toml` that
