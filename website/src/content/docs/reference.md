...
| [agent](/docs/internal/agent) | dayscript, recording, and the agent-facing tooling |
...
`day-piece-rating`, `day-piece-settings`, and `day-piece-remote-image` ship without reference
pages yet; their crate docs are the reference.
...
| [notify](/docs/internal/notify) | `day-part-local-notify` |
