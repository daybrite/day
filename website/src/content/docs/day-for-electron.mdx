...
of time and builds your UI from the platform's widgets: `NSButton` and `NSMenu` on macOS, GTK 4
...
| `fetch` / Node `net` | [`day-part-http`](/docs/guide-http) — each platform's networking stack |
...
<span id="form-controls-are-the-platforms-own"></span>

## Native form controls

Form controls bind two ways, and each one is the platform's control, which supplies
