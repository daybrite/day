...
Electron renders a web interface using Chromium and Node.js. Day compiles Rust code into an app
that uses native toolkit controls. Moving between them changes UI composition, process
communication, dependencies, and packaging; this guide compares those areas with code examples.
...
| `<webview>` / `WebContentsView` | [`day-piece-webview`](https://github.com/daybrite/day-piece-webview) — the system webview |
...
`.dmg`. Remote content goes through [`day-piece-webview`](https://github.com/daybrite/day-piece-webview), which hosts the
...
writing TypeScript, [`day-lite`](https://github.com/daybrite/day-lite) runs JS/TS miniapps on top of Day's native
