...
| --- | --- | --- | --- |
| `web-dom.svg` | [Simple Icons](https://simpleicons.org) 16.28.0 | HTML5 | [CC0 1.0](https://creativecommons.org/publicdomain/zero/1.0/) |
| `android-mdc.svg` | Simple Icons 16.28.0 | Android | CC0 1.0 |
| `ios-uikit.svg` | [Material Symbols](https://fonts.google.com/icons) | `phone_iphone` (filled) | [Apache 2.0](https://www.apache.org/licenses/LICENSE-2.0) |
...
Two icons could not come from it:
...
- **`ios-uikit`** — Simple Icons' `ios` is a wordmark, and reusing the Apple logo would make the
  iOS and macOS cards identical. A device silhouette distinguishes them.
