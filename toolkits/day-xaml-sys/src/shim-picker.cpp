...
// `day_xaml_box`/`day_xaml_unbox` seam that day-xaml-sys exports, so this piece carries its own
// XAML native code with ZERO edits to day's toolkit crates (the whole point of the seam).
//
