...
Raw `extern "C"` declarations plus the C++/WinRT XAML-Islands shim that
[`day-winui`](https://crates.io/crates/day-winui) drives.
...
is `day-winui`, and apps depend on neither directly (the backend arrives via a cargo
