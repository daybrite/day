...
pub mod prelude {
    ...
    pub use crate::{
        ...
        IntoReactive, IntoText, ItemSlot, List, MenuEntry, Prompt, Reactive, Selector,
        SelectorStyle, ShapeKind, ShapePiece, SignalRw, Stack, VAlign, alert, app_menu, arc,
        button, canvas, capsule, circle, column, confirm, divider, each, ellipse, image, label,
        list, menu_item, menu_role, menu_separator, nav_back, nav_link, navigate, progress, prompt,
        rectangle, rounded_rectangle, row, scroll, selector, shape, slider, spacer, spinner, stack,
        sub_menu, text_field, toggle, when,
    };
