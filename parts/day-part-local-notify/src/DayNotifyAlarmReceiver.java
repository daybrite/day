...
// platform/android/components.xml ([package.metadata.day.android].manifest-components); without
// that declaration Android never instantiates this class, and the APK installs, runs, and silently
// never delivers.
//
