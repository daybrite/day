...
android {
    namespace = "dev.daybrite.daylite"
    compileSdk = 35
    defaultConfig {
        applicationId = dayApp.getProperty("applicationId") ?: "dev.daybrite.daylite"
        minSdk = 24
        targetSdk = 35
        ...
        manifestPlaceholders["dayTitle"] = dayApp.getProperty("title") ?: "Daylite"
