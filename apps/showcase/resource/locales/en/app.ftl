...
list-row = Row { $n }
text-style-large-title = Large Title
text-style-title = Title
text-style-title2 = Title 2
text-style-title3 = Title 3
text-style-headline = Headline
text-style-subheadline = Subheadline
text-style-body = Body
text-style-callout = Callout
text-style-footnote = Footnote
text-style-caption = Caption
text-style-caption2 = Caption 2
text-weight-ultralight = Ultra Light
text-weight-light = Light
text-weight-regular = Regular
text-weight-medium = Medium
text-weight-semibold = Semibold
text-weight-bold = Bold
text-weight-heavy = Heavy
text-weight-black = Black
text-bold = Bold text
text-italic = Italic text
text-bolditalic = Bold italic
text-emphasis-label = Emphasis
color-red = Red
color-green = Green
color-blue = Blue
color-orange = Orange
